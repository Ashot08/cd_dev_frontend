...
export const CreateUserMassForm = (props) => {
    ...
    return (
        <div className={classes.cd__students_mass_adding}>
            ...
            <Link target={'_blank'} download={true} className={classes.cd__students_mass_template_link} to={"/wp-content/plugins/courses_dashboard_2/views/program/add_students_template.xlsx"}>
